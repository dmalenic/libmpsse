...
try:
    ...
    ds1305.Start()
    ds1305.Write(bytes([0x0F]))
    #control = ord(ds1305.Read(1))
    control = ds1305.Read(1)[0]
    ds1305.Stop()
    ...
    ds1305.Start()
    ds1305.Write(bytes([0x8F]))
    #ds1305.Write(chr(control))
    ds1305.Write(bytes([control]))
    ds1305.Stop()
    ...
    while True:
        ...
        try:
            ...
            ds1305.Start()
            ds1305.Write(bytes([0x00]))
            #seconds = ord(ds1305.Read(1))
            seconds = ds1305.Read(1)[0]
            ds1305.Stop()
            ...
            ds1305.Start()
            ds1305.Write(bytes([0x01]))
            #minutes = ord(ds1305.Read(1))
            minutes = ds1305.Read(1)[0]
            ds1305.Stop()
