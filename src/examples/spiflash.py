...
class SPIFlash(object):
    ...
    WCMD = bytes([0x02])    # Standard SPI flash write command (0x02)
    RCMD = bytes([0x03])    # Standard SPI flash read command (0x03)
    WECMD = bytes([0x06])   # Standard SPI flash write enable command (0x06)
    CECMD = bytes([0xc7])   # Standard SPI flash chip erase command (0xC7)
    IDCMD = bytes([0x9f])   # Standard SPI flash chip ID command (0x9F)
